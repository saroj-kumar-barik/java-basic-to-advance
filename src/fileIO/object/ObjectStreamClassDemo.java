...
// Java code illustrating forClass() - to get class/Interface name,
// lookup() - takes a class as input
// and lookupAny() - takes class as input
public class ObjectStreamClassDemo {
    ...
    public static void main(String arg[]) {
        ...
        ObjectStreamClass quiz_stream
                = ObjectStreamClass.lookupAny(ObjectStreamClass.class);
        ObjectStreamClass quiz_stream1
                = ObjectStreamClass.lookupAny(Serializable.class);
